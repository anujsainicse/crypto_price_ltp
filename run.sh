...
echo "    • Bybit Spot Service"
echo "    • CoinDCX Futures LTP Service"
echo "    • CoinDCX Funding Rate Service"
echo ""
echo "  Delta services remain stopped - start them from the dashboard if needed."
echo ""
echo "=========================================="
